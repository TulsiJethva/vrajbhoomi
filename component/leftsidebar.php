...
<ul class="x-navigation">
    ...
    <?php if($_SESSION['suraj_admin_right']=='ticketwindow'){ ?>
        ...
        <li <?php if($menuname=='printpending.php'){ echo 'class="active"'; }?> >
            <a href=<?php echo ADMIN_SITE.'printpending.php';?> title="Freeze / Release" >
                <span class="fa fa-print"></span>
                <span class="xn-text">Print Pending Ticket</span>
            </a>
        </li>
        <li>
            <a href="#" class="mb-control" data-box="#mb-signout">
